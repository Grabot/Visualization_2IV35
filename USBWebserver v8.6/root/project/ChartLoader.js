function drawChart( chartData )
{
    ...
    x.addOrderRule(['00-04', '05-09', '10-14', '15-19', '20-24', '25-29', '30-34', '35-39', '40-44', '45-49', '50-54', '55-59', '60-65', '65-69', '70-74', '75-79', '80-84', '85-89', '90-94', '95-EO', '00-14', '15-24', '25-44', '45-64', '65-EO']);
    var y1 = chart.addMeasureAxis("y", "Pecentage");
    y1.tickFormat = ',.1f';
    var bars = chart.addSeries("City", dimple.plot.bar, [x, y1]);
