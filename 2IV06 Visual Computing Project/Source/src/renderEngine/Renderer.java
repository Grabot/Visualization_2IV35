...
public class Renderer {
	...
	public void render(RawModel model) {
		...
		GL11.glDrawElements(GL11.GL_LINE_STRIP, model.getVertexCount(), GL11.GL_UNSIGNED_INT, 0);
	...
	public void render(Entity entity, StaticShader shader) {
		...
		Matrix4f transformationMatrix = Maths.createTransformationMatrix(entity
				.getPosition(), entity.getRotation(), entity.getScale());
		shader.loadTransformationMatrix(transformationMatrix);
		GL13.glActiveTexture(GL13.GL_TEXTURE0);
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, model.getTexture().getID());
		GL11.glLineWidth(20f);
		GL11.glDrawElements(GL11.GL_LINE_STRIP, rawModel.getVertexCount(), GL11.GL_UNSIGNED_INT, 0);
		GL20.glDisableVertexAttribArray(0);
		GL20.glDisableVertexAttribArray(1);
